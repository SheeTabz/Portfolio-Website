    ...
    <section id='about' className='aboutSection bg-dark text-white'>
      <div className=' container mx-auto'>
        <div className=' aboutImg z-40 flex flex-col xl:flex-row gap-30 py-40 '>
          ...
          <div className='flex flex-col items-center text-center lg:items-start lg:text-left lg:ml-40 sm:mr-0'>
            <div className='flex flex-col'>
              <h2 className='about-h2 text-3xl text-white lg:text-4xl font-medium lg:font-extrabold mb-3 relative
                before:contetext-centernt-about before:absolute  before:opacity-40 before:-top-[2rem] before:hidden before:lg:block before:text-yellow '>Tabitha Muriithi</h2>
